...
| **happy-gateway** | A [Krakend CE](https://www.krakend.io) configuration to propose a gateway with feature of JWT sign and validation on API verbs. | prod | private | Krankend yaml |
